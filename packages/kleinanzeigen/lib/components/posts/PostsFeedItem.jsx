...
import { Components, registerComponent, ModalTrigger, Utils } from 'meteor/vulcan:core';

import { FormattedMessage } from 'meteor/vulcan:i18n';

import { Posts } from '../../modules';

class PostsFeedItem extends PureComponent {
  ...
  render() {
    ...
    return (
      <ListGroupItem className={postClass}>
...
PostsFeedItem.propTypes = {
  currentUser: PropTypes.object,
  post: PropTypes.object.isRequired,
  terms: PropTypes.object,
};

registerComponent('PostsFeedItem', PostsFeedItem);
