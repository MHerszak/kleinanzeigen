...
import { Components, replaceComponent, withCurrentUser, Callbacks, runCallbacks } from 'meteor/vulcan:core';
...
replaceComponent('AccountsLoginForm', AccountsLoginForm, withCurrentUser, withApollo);
